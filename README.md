...
This server handles secure OAuth integration with **GitHub** and **Microsoft Entra ID**, JWT token generation, and session management for the [Next.JS frontend](https://github.com/mbeps/oauth-nextjs-springboot-frontend). 
